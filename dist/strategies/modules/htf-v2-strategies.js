 ...
 */
export class HtfFundingSkewStrategy {
 ...
 */
export class HtfRangeRetestStrategy {
 ...
 */
export class HtfWyckoffSpringStrategy {
    ...
    execute(ctx) {
        ...
        if (rangeSize <= 0)
            return null;
        if (rangeSize > indicators.atr * 6)
            return null; // too wide, not a range
 ...
 */
export class HtfOpenInterestDivergenceStrategy {
    name = 'HTF OI Divergence';
    id = 'htf-oi-divergence';
    execute(ctx) {
        const { candles, indicators, openInterest } = ctx;
        if (!openInterest || openInterest.oiHistory.length < 10)
            return null;
...
//# sourceMappingURL=htf-v2-strategies.js.map